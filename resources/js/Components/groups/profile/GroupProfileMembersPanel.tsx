    ...
    return (
        <TabPanel>
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-8">
                ...
                >
                    <div className="rounded-xl bg-white p-3 shadow-lg ring-1 ring-gray-200 sm:p-6 dark:bg-gray-800 dark:ring-gray-800">
                        {/* Header Section */}
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                ...
                                <span className="rounded-full bg-green-100 px-2.5 py-1 text-xs font-medium text-green-600 dark:bg-green-900/30 dark:text-green-400">
                                    Active
                                </span>
                            </div>
                        </div>
