                ...
                <div className="relative py-12">
                    <div className="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
                        ...
                        <motion.div
                            ...
                            className="rounded-xl bg-white p-4 shadow-lg ring-1 ring-gray-200 sm:p-8 dark:bg-gray-800 dark:ring-gray-700"
                        >
                        ...
                        <motion.div
                            ...
                            className="rounded-xl bg-white p-4 shadow-lg ring-1 ring-red-200 sm:p-8 dark:bg-gray-800 dark:ring-red-700/50"
                        >
