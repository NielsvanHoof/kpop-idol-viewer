                ...
                Section::make('Basic Information')
                    ...
                    ->schema([
                        ...
                        TextInput::make('stage_name')
                            ->label('Stage Name')
                            ->placeholder("Enter the idol's stage name"),

                        TextInput::make('position')
                            ->label('Position')
                            ->placeholder("Enter the idol's position in the group"),
                        ...
                        TextInput::make('agency')
                            ->label('Agency')
                            ->placeholder("Enter the idol's agency"),

                        TextInput::make('country')
                            ->label('Country')
                            ->placeholder("Enter the idol's country"),
                ...
                Section::make('Statistics')
                    ->schema([
                        Placeholder::make('followers_count')
                            ->label('Followers')
                            ->content(fn (?Idol $record): string => number_format($record?->followers()->count() ?? 0)),

                        Placeholder::make('likes_count')
                            ->label('Likes')
                            ->content(fn (?Idol $record): string => number_format($record?->likes()->count() ?? 0)),

                        Placeholder::make('views_count')
                            ->label('Views')
                            ->content(fn (?Idol $record): string => number_format($record?->views()->count() ?? 0)),
